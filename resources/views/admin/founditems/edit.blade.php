...
<!-- Content Row -->
        <div class="card shadow">
            ...
            <h5 class="font-weight-bold text-primary">{{ __('Edit Found Items') }}</h5>
                <div class="ml-auto">
            ...
            <div class="card-body">
                <form action="{{ route('admin.founditems.update', $founditems->id )}}" method="POST">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" id="found_date" placeholder="" name="found_date" value="{{ $founditems->found_date }}" />
                    </div>
