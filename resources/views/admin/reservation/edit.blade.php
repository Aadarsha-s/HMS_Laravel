    ...
    <div class="container-fluid">
        ...
        <div class="card shadow">
            <div class="card-header py-3 d-flex">
                <h5 class="font-weight-bold text-primary">{{ __('Edit reservations') }}</h5>
                <div class="ml-auto">
                ...
                <form action="{{ route('admin.reservation.update', $reservations->id) }}" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" aria-label="Default select example" id="reservation_for"
                                name="reservation_for" required>

                                <option value="Single" {{ $reservations->reservation_for == 'Single' ? 'selected' : '' }}>
                                    Single</option>
                                <option value="Double" {{ $reservations->reservation_for == 'Double' ? 'selected' : '' }}>
                                    Double</option>
                                <option value="Triple" {{ $reservations->reservation_for == 'Triple' ? 'selected' : '' }}>
                                    Triple</option>
                                <option value="For 4" {{ $reservations->reservation_for == 'For 4' ? 'selected' : '' }}>For
                                    4</option>
                                <option value="For 5" {{ $reservations->reservation_for == 'For 5' ? 'selected' : '' }}>
                                    For 5</option>
                                <option value="5 above"
                                    {{ $reservations->reservation_for == '5 above' ? 'selected' : '' }}>5 above</option>
                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" aria-label="Default select example" id="reservation_type"
                                ...
                                <option value="Guaranted"
                                    {{ $reservations->reservation_for == 'Guaranted' ? 'selected' : '' }}>Guaranted
                                </option>
                                <option value="Not Guaranted"
                                    {{ $reservations->reservation_for == 'Not Guaranted' ? 'selected' : '' }}>Not Guaranted
                                </option>
                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" aria-label="Default select example" id="room_type" name="room_type"
                                required>
                                <option value="Single" {{ $reservations->room_type == 'Single' ? 'selected' : '' }}>Single
                                </option>
                                <option value="Double" {{ $reservations->room_type == 'Double' ? 'selected' : '' }}>Double
                                </option>
                                <option value="Triple" {{ $reservations->room_type == 'Triple' ? 'selected' : '' }}>Triple
                                </option>
                                <option value="Quad" {{ $reservations->room_type == 'Quad' ? 'selected' : '' }}>Quad
                                </option>
                                <option value="Twin" {{ $reservations->room_type == 'Twin' ? 'selected' : '' }}>Twin
                                </option>
                                <option value="Cabana" {{ $reservations->room_type == 'Cabana' ? 'selected' : '' }}>Cabana
                                </option>
                                <option value="Connecting Rooms"
                                    {{ $reservations->room_type == 'Connecting Rooms' ? 'selected' : '' }}>Connecting Rooms
                                </option>
                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" aria-label="Default select example" id="room_number"
                                ...
                                @foreach($rooms as $room)
                                    @if ($room->room_type == "Single")
                                        <option class="Single" value="{{$room->room_number}}" {{ $reservations->room_number == $room->room_number ? 'selected' : '' }}>{{$room->room_number}}</option>
                                    @elseif ($room->room_type == "Double")
                                        <option class="Double" value="{{$room->room_number}}" {{ $reservations->room_number == $room->room_number ? 'selected' : '' }}>{{$room->room_number}}</option>
                                    @elseif ($room->room_type == "Triple")
                                        <option class="Triple" value="{{$room->room_number}}" {{ $reservations->room_number == $room->room_number ? 'selected' : '' }}>{{$room->room_number}}</option>
                                    @elseif ($room->room_type == "Quad")
                                        <option class="Quad" value="{{$room->room_number}}" {{ $reservations->room_number == $room->room_number ? 'selected' : '' }}>{{$room->room_number}}</option>
                                    @elseif ($room->room_type == "Twin")
                                        <option class="Twin" value="{{$room->room_number}}" {{ $reservations->room_number == $room->room_number ? 'selected' : '' }}>{{$room->room_number}}</option>
                                    @elseif ($room->room_type == "Cabana")
                                        <option class="Cabana" value="{{$room->room_number}}" {{ $reservations->room_number == $room->room_number ? 'selected' : '' }}>{{$room->room_number}}</option>
                                    @elseif ($room->room_type == "Connecting Rooms")
                                        <option class="ConnectingRooms" value="{{$room->room_number}}" {{ $reservations->room_number == $room->room_number ? 'selected' : '' }}>{{$room->room_number}}</option>
                                    @endif
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name"
                                value="{{ old('first_name', $reservations->first_name) }}" required>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="middle_name">{{ __('Middle Name ') }}</label>
                            <input type="text" class="form-control" id="middle_name" name="middle_name"
                                value="{{ old('middle_name', $reservations->middle_name) }}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="last_name">{{ __('Last Name ') }}</label>
                            <input type="text" class="form-control" id="last_name" name="last_name"
                                value="{{ old('last_name', $reservations->last_name) }}" required>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="address">{{ __('Address ') }}</label>
                            <input type="text" class="form-control" id="address" name="address"
                                value="{{ old('address', $reservations->address) }}" required>
                        </div>
                    </div>
                        ...
                        <tbody>
                            @foreach ($rooms as $room)
                                @if ($room->room_type == 'Single')
                                    ...
                                    <div class="col-md-4">    
                                        ...
                                        <td class="table-group Single "><input type="number"
                                                class="form-control col-md-3 pax" id="pax" /></td>
                                        <td class="table-group Single ">Rs. <input type="hidden" readonly class="rate"
                                ...
                                @if ($room->room_type == 'Double')
                                    ...
                                    <div class="col-md-4">    
                                        ...
                                        <td class="table-group Double "><input type="number"
                                                class="form-control col-md-3 pax" id="pax" /></td>
                                        <td class="table-group Double ">Rs. <input type="hidden" readonly class="rate"
                                                value="{{ old('room_rate', $room->room_rate) }}" />{{ $room->room_rate }}
                                        </td>
                                        <td class="table-group Double "><input type="number"
                                                class="form-control col-md-5 total" readonly /></td>
                                ...
                                @if ($room->room_type == 'Triple')
                                    ...
                                    <div class="col-md-4">    
                                        ...
                                        <td class="table-group Triple "><input type="number"
                                                class="form-control col-md-3 pax" id="pax" /></td>
                                        <td class="table-group Triple ">Rs. <input type="hidden" readonly class="rate"
                                                value="{{ old('room_rate', $room->room_rate) }}" />{{ $room->room_rate }}
                                        </td>
                                        <td class="table-group Triple "><input type="number"
                                                class="form-control col-md-5 total" readonly /></td>
                                ...
                                @if ($room->room_type == 'Quad')
                                    ...
                                    <div class="col-md-4">    
                                        ...
                                        <td class="table-group Quad "><input type="number"
                                                class="form-control col-md-3 pax" id="pax" /></td>
                                        <td class="table-group Quad ">Rs. <input type="hidden" readonly class="rate"
                                                value="{{ old('room_rate', $room->room_rate) }}" />{{ $room->room_rate }}
                                        </td>
                                        <td class="table-group Quad "><input type="number"
                                                class="form-control col-md-5 total" readonly /></td>
                                ...
                                @if ($room->room_type == 'Twin')
                                    ...
                                    <div class="col-md-4">    
                                        ...
                                        <td class="table-group Twin "><input type="number"
                                                class="form-control col-md-3 pax" id="pax" /></td>
                                        <td class="table-group Twin ">Rs. <input type="hidden" readonly class="rate"
                                                value="{{ old('room_rate', $room->room_rate) }}" />{{ $room->room_rate }}
                                        </td>
                                        <td class="table-group Twin "><input type="number"
                                                class="form-control col-md-5 total" readonly /></td>
                                ...
                                @if ($room->room_type == 'Cabana')
                                    ...
                                    <div class="col-md-4">    
                                        ...
                                        <td class="table-group Cabana "><input type="number"
                                                class="form-control col-md-3 pax" id="pax" /></td>
                                        <td class="table-group Cabana ">Rs. <input type="hidden" readonly class="rate"
                                                value="{{ old('room_rate', $room->room_rate) }}" />{{ $room->room_rate }}
                                        </td>
                                        <td class="table-group Cabana "><input type="number"
                                                class="form-control col-md-5 total" readonly /></td>
                                ...
                                @if ($room->room_type == 'Connecting Rooms')
                                    ...
                                    <div class="col-md-4">    
                                        ...
                                        <td class="table-group ConnectingRooms "><input type="number"
                                                class="form-control col-md-3 pax" id="pax" /></td>
                                        <td class="table-group ConnectingRooms ">Rs. <input type="hidden" readonly
                                                class="rate"
                                                value="{{ old('room_rate', $room->room_rate) }}" />{{ $room->room_rate }}
                                        </td>
                                        <td class="table-group ConnectingRooms "><input type="number"
                            ...
                            <tr>
                                ...
                                <th scope="row" class="table-group">Total Amount<input type="number"
                                        class="form-control col-md-4 totalamt" id="totalamt" name="totalamt" readonly />
                            </tr>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" aria-label="Default select example" id="request_type"
                                ...
                                <option value="Direct Guest"
                                    {{ $reservations->request_type == 'Direct Guest' ? 'selected' : '' }}>Direct Guest
                                </option>
                                <option value="Travel Agencies"
                                    {{ $reservations->request_type == 'Travel Agencies' ? 'selected' : '' }}>Travel
                                    Agencies</option>
                                <option value="Central reservations System"
                                    {{ $reservations->request_type == 'Central reservations System' ? 'selected' : '' }}>
                                    Central reservations System</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control special_request_rate" id="special_request_rate"
                                name="special_request_rate"
                                value="{{ old('special_request_rate', $reservations->special_request_rate) }}" required />
                        </div>
                    </div>
                    <br><br>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" aria-label="Default select example" id="room_plan"
                                ...
                                <option value="American Plan"
                                    {{ $reservations->room_plan == 'American Plan' ? 'selected' : '' }}>American Plan
                                </option>
                                <option value="Modified American Plan"
                                    {{ $reservations->room_plan == 'Modified American Plan' ? 'selected' : '' }}>Modified
                                    American Plan</option>
                                <option value="Continental Plan"
                                    {{ $reservations->room_plan == 'Continental Plan' ? 'selected' : '' }}>Continental
                                    Plan</option>
                                <option value="European Plan"
                                    {{ $reservations->room_plan == 'European Plan' ? 'selected' : '' }}>European Plan
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control room_plan_rate" id="room_plan_rate"
                                name="room_plan_rate" value="{{ old('room_plan_rate', $reservations->room_plan_rate) }}"
                                required />
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" aria-label="Default select example" id="payment_mode"
                                ...
                                <option value="Cash in hand"
                                    {{ $reservations->payment_mode == 'Cash in hand' ? 'selected' : '' }}>Cash in hand
                                </option>
                                <option value="Credit Card"
                                    {{ $reservations->payment_mode == 'Credit Card' ? 'selected' : '' }}>Credit Card
                                </option>
                                <option value="Debit Card"
                                    {{ $reservations->payment_mode == 'Debit Card' ? 'selected' : '' }}>Debit Card
                                </option>
                                <option value="Voucher" {{ $reservations->payment_mode == 'Voucher' ? 'selected' : '' }}>
                                    Voucher</option>
                            </select>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr class="txttotal">
                                    ...
                                    <td><input type="number" class="form-control col-md-3 room_plan_result "
                                            id="room_plan_result"value="{{ old('room_plan_result') }}" readonly /></td>
                                </tr>
                                <tr>
                                    <th scope="col">Grand Total</th>
                                    <td><input type="number" class="form-control col-md-3" id="grandtotal"
                                            style="color:red;" name="total_rate"
                                            value="{{ old('total_rate', $reservations->total_rate) }}"readonly /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="date" class="form-control" id="arrival_date" name="arrival_date"
                                value="{{ old('arrival_date', $reservations->arrival_date) }}" required>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="arrival_time">{{ __('Arrival Time ') }}</label>
                            <input type="time" class="form-control" id="arrival_time" name="arrival_time"
                                value="{{ old('arrival_time', $reservations->arrival_time) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="date" class="form-control" id="departure_date" name="departure_date"
                                value="{{ old('departure_date', $reservations->departure_date) }}" required>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="departure_time">{{ __('Departure Time ') }}</label>
                            <input type="time" class="form-control" id="departure_time" name="departure_time"
                                value="{{ old('departure_time', $reservations->departure_time) }}" required>
                        </div>
                    </div>  
