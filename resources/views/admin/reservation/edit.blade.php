                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" aria-label="Default select example" id="room_type" name="room_type"
                                ...
                                <option value="{{ $item->room_type }}"
                                    @if(old('room_type',$reservations->room_type) == $item->room_type) selected @endif >
                                    {{ $item->room_type }}
                                </option>
                                @endforeach     
                            </select>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" aria-label="Default select example" id="room_number"
                                ...
                                @foreach($rooms as $room)
                                    @foreach($roomtypes as $item)
                                        @if ($room->room_type == $item->room_type)
                                            <option class="{{$item->room_type}}" value="{{$room->room_number}}" {{ $reservations->room_number == $room->room_number ? 'selected' : '' }}>{{$room->room_number}}</option>
                                        @endif
                                @endforeach
                                @endforeach
                            </select>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" id="country" name="country"
                                value="{{ old('country', $reservations->country) }}">
                        </div>
                    </div>
